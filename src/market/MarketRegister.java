...
public class MarketRegister {
	...
	public void register() {
		...
		jr_yes.setBounds(146, 207, 91, 34);
		regPane.add(jr_yes);
		...
		jc_method.setModel(new DefaultComboBoxModel(new String[] {"택배","직거래","택배 또는 직거래"}));
		jc_method.setFont(new Font("제주고딕", Font.PLAIN, 12));
		jc_method.setBackground(Color.WHITE);
		jc_method.setBounds(150, 264, 119, 23);
		regPane.add(jc_method);

		jc_area = new JComboBox();
		jc_area.setModel(new DefaultComboBoxModel(new String[] {"경기도","강원도","충청남도","충청북도","전라남도","전라북도","충청남도","충청북도","경상남도","경상북도","제주도"}));
		jc_area.setFont(new Font("제주고딕", Font.PLAIN, 12));
		jc_area.setBackground(Color.WHITE);
		jc_area.setBounds(150, 318, 119, 23);
		regPane.add(jc_area);
		
		btnReg = new JButton("\uC0C1\uD488 \uB4F1\uB85D");
		btnReg.setForeground(new Color(153, 204, 255));
		btnReg.setBackground(Color.DARK_GRAY);
		btnReg.setBounds(356, 476, 91, 27);
		regPane.add(btnReg);
		
		btnReset = new JButton("\uC0C1\uD488 \uCDE8\uC18C");
		btnReset.setForeground(new Color(153, 204, 255));
		btnReset.setBackground(Color.DARK_GRAY);
		btnReset.setBounds(459, 476, 91, 27);
